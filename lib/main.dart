...
//
//   AppinioSwiperController _swiperController = AppinioSwiperController();
//   int swipedNewsCount = 0;
//   int maxNonSubscribedNews = 15;
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
//           child: AppinioSwiper(
//             padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 10),
//             cardsCount: swipedNewsCount >= maxNonSubscribedNews
//                 ? newsList.length + 1 // Add 1 for subscription card
//                 : newsList.length,
//             //loop: true,
//             swipeOptions: const AppinioSwipeOptions.only(
//               top: true,
...
//             },
//             cardsBuilder: (BuildContext context, int index) {
//               if (swipedNewsCount >= maxNonSubscribedNews) {
...
//                   ElevatedButton(
//                     onPressed: () {
//                       // Implement the logic for subscribing here
//                     },
//                     style: ElevatedButton.styleFrom(
//                       backgroundColor: Colors.black,
//                       shape: RoundedRectangleBorder(
